...
<div id="corpo-form">
	<h1>Entrar</h1>
	<form method="POST" action="/CursoCode/index.php/Login/autenticarGerente">
		Email: <input type="email" name="email" placeholder="Email">
		Senha: <input type="password" name="senha" placeholder="Senha">
		<input type="submit" value="Acessar">
		<a href="/CursoCode/index.php/Gerente/cadastro">Ainda não é inscrito? <strong>Cadastre-se</strong></a>
