...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/CursoCode/css/estiloCadLog.css?version=12">
...
<div id="corpo-form-cad">
	<h1>Cadastrar</h1>
	<form method="POST" action="/CursoCode/index.php/Gerente/recebePostFuncionario">
		...
		Salário: <input type="text" name="salario" placeholder="Salário" maxlength="20">
		Senha: <input type="password" id="senha" name="senha" placeholder="Senha" maxlength="15">
		Confirmar Senha: <input type="password" name="confirmar_senha" placeholder="Confirmar Senha" maxlength="15">
		<input type="submit" value="Cadastrar">
		<a id="personalizado" href="/CursoCode/index.php/Gerente/telaSessaoGerente">Voltar</a>
